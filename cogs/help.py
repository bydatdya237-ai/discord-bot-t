...
class HelpSelect(discord.ui.Select):
    def __init__(self, bot):
        ...
        options = [
            ...
            discord.SelectOption(label="أوامر الأعضاء", description="الأوامر العامة المتاحة للجميع مثل الاستدعاء", emoji="👤")
        ]
...
class HelpCog(commands.Cog):
    ...
    @commands.command(name="اوامر", help="يعرض قائمة بجميع الأوامر بشكل تفاعلي ومنظم")
